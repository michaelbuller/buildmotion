 ...
 */
export declare class StringIsValidDateString extends CompositeRule {
    /**
     ...
     */
    constructor(name: string, message: string, target: string | Date | undefined, isDisplayable?: boolean);
    /**
