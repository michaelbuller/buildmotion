...
This rules engine can be used and shared by Angular and NestJS applications. If you are using a monorepo, you can create shared rules for your Angular and NestJS applications (e.g., frontend and backend).

The rules engine can be used straight away with a set of off-the-shelf rules. You can combine these rules to create more complex composite rules. The rule engine also contains a set of rule framework classes that allow you to create any custom rule from simple to complex.
...
The question should really be why are you *not* using a rule engine. Please consider the following.
...
&copy; 2016-2022, Build Motion [www.AngularArchitecture.com](http://www.AngularArchitecture.com)